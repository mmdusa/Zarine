          ...
          body={
            <>
              ...
              <p className="mt-3">
                ...
                <strong>Sargol</strong> strands with a deep red hue and vivid aroma.
              </p>
            </>
          }
        />
          ...
          body={
            <>
              <p>
                ...
                distilled into red filaments.
              </p>
              <p className="mt-3">
                We seal our saffron in <strong>airtight, handcrafted tins</strong> that
                shield it from light and air. Open the lid and the room blooms.
              </p>
            </>
          }
        />
