// app/learn/saffron/page.tsx
// This is your restored Persian Saffron history & harvest scroll story page
          ...
          body={
            <>
              <p>
                ...
                poetry. Each autumn across Iran’s high plateaus,{" "}
                <em>Crocus sativus</em> blooms for only a few precious weeks.
              </p>
              <p className="mt-3">
                At <strong>dawn</strong>, before sunlight warms the petals, farmers
                hand-pick the blossoms to protect the volatile aromas. Inside every flower
                lie three crimson stigmas—the threads we call saffron—gently plucked and
          ...
          body={
            <>
              <p>
                ...
                <strong>picrocrocin</strong> (taste)—the natural trinity behind its glow,
                perfume, and gentle bitterness.
              </p>
              <p className="mt-3">
                ...
                and a vivid honey-floral aroma. The result: fewer strands for more color,
                more fragrance with every pinch.
              </p>
            </>
          }
        />
        ...
        <SaffronSection
          ...
          body={
            <>
              ...
              <p className="mt-3">
                We seal our saffron in <strong>airtight, handcrafted tins</strong> that
                shield it from light and air, preserving its character from field to
                kitchen. Open the lid and the room blooms—Persia, in a breath.
              </p>
            </>
          }
        />
